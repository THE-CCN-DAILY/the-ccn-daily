...
const nextStepsData: NextStepItem[] = [
  ...
  { id: 'step9', text: "Review the new episode summaries, now visible in the detailed player's default 'Summary' tab.", isCompleted: true },
  { id: 'step10', text: 'Review the new thematic search feature, which allows searching within episode transcripts.', isCompleted: true },
  { id: 'step11', text: "Review the new note tagging and filtering in the Reader Prototype's 'Smart Library'.", isCompleted: true },
  { id: 'step12', text: "Review the prayer companion's new long-term memory feature, enabling more contextual conversations.", isCompleted: true },
  ...
  { id: 'step14', text: "Review and approve the Founder's Voice instructions now guiding devotional preparation.", isCompleted: true },
  ...
  { id: 'step43', text: 'Review and approve the updated Master Plan, which now includes proposals for atmospheric prayer music and premium narration.', isCompleted: true },
  { id: 'step44', text: "Review the new premium narration. In the Reader, go to Settings -> Narrator Voice, choose a voice, and test the 'Read Aloud' feature.", isCompleted: true },
  { id: 'step45', text: "Review the fixes and UX improvements for narration. The correct audio now plays, voices are distinct, and a quick-access voice selector has been added to the reader toolbar.", isCompleted: true },
  { id: 'step46', text: "Verify the definitive fix for narration: confirm audio plays without error and the voice selector is now a quick-access popover on the toolbar (removed from Settings).", isCompleted: true },
  { id: 'step47', text: "Verify the narration feature now provides audible feedback. Clicking 'Read Aloud' should play a short beep sound, confirming the audio system is working. Toggling the button should correctly play/pause this sound.", isCompleted: true },
  { id: 'step48', text: "Review the atmospheric music prototype. Select different moods to hear the corresponding ambient music and test the playback controls.", isCompleted: true },
  ...
  { id: 'step57', text: 'Review the updated "Visual Sanctuary" for cinematic prayer backgrounds.', isCompleted: true },
  ...
  { id: 'step59', text: 'Review the enhanced "Course Studio" in the Admin Dashboard, designed to turn newsletters/books into interactive courses.', isCompleted: true },
